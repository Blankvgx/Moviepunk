...
const imageList = new Map([
    ["quote1.png", "./images/quote1.png"],
    ["quote2.png", "./images/quote2.png"],
    ["quote3.png", "./images/quote3.png"]
]);
...
let imagePicker = document.getElementById("imagePickerQuotes"); // Targeting the Borders container
