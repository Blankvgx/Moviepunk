...
const imageList = new Map([
    ["border1.png", "./images/border1.png"],
    ["border2.png", "./images/border2.png"],
    ["border3.png", "./images/border3.png"]
]);
...
let imagePicker = document.getElementById("imagePickerBorders"); // Targeting the Borders container
